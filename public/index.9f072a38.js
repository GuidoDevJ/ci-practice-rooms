...
})({"YYQ28":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "408daf3e9f072a38";
"use strict";
...
var _router1 = require("@vaadin/router");
(function() {
    // Propuesta:
    ...
    if (cs.rtdbId && cs.userId) (0, _router1.Router).go("/chat");
})();

},{"./router":"asTyk","./state":"gYADE","@vaadin/router":"kVZrF"}],"asTyk":[function(require,module,exports) {
var _router = require("@vaadin/router");
var _welcome = require("./pages/inicio/welcome");
var _chat = require("./pages/chat/chat");
const router = new (0, _router.Router)(document.querySelector(".root"));
router.setRoutes([
    {
        path: "/",
        component: "custom-home"
    },
    {
        path: "/chat",
        component: "chat-page"
...
},{"@vaadin/router":"kVZrF","./pages/inicio/welcome":"dMkZs","./pages/chat/chat":"klKMg"}],"kVZrF":[function(require,module,exports) {
   ...
   */ render(pathnameOrContext, shouldUpdateHistory) {
    ...
    __runOnBeforeCallbacks(newContext) {
        ...
        if (previousChain.length) {
            ...
            for(let i3 = previousChain.length - 1; i3 >= newContext.__divergedChainIndex; i3--)callbacks = this.__runOnBeforeLeaveCallbacks(callbacks, newContext, {
                prevent
            }, previousChain[i3]);
        }
        // execute onBeforeEnter when NOT skipping attach
        if (!newContext.__skipAttach) for(let i4 = 0; i4 < newChain.length; i4++){
            if (i4 < newContext.__divergedChainIndex) {
                if (i4 < previousChain.length && previousChain[i4].element) previousChain[i4].element.location = createLocation(newContext, previousChain[i4].route);
            } else {
                callbacks = this.__runOnBeforeEnterCallbacks(callbacks, newContext, {
                    prevent,
                    redirect
                }, newChain[i4]);
                if (newChain[i4].element) newChain[i4].element.location = createLocation(newContext, newChain[i4].route);
            }
        }
...
},{}],"dMkZs":[function(require,module,exports) {
var _header = require("../../components/header/header");
var _btn = require("../../components/button/btn");
var _state = require("../../state");
var _router = require("@vaadin/router");
class Home extends HTMLElement {
    ...
    render() {
        ...
        btn?.addEventListener("click", (e)=>{
            ...
            (0, _state.state).setEmailAndFullname(email, name);
            if ($room.value === "new") (0, _state.state).singIn((error)=>{
                if (error) console.error("hubo un error en el signIn");
                (0, _state.state).askNewRoom(()=>{
                    (0, _state.state).getData();
                    (0, _router.Router).go("/chat");
                });
            });
            else if ($room.value === "old") {
                (0, _state.state).sincronizarDatos($id.value);
                (0, _router.Router).go("/chat");
            }
        });
...
},{"../../components/header/header":"adC58","../../components/button/btn":"8Djxy","../../state":"gYADE","@vaadin/router":"kVZrF"}],"adC58":[function(require,module,exports) {
...
},{}],"8Djxy":[function(require,module,exports) {
...
},{}],"gYADE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const state = {
    ...
    listenRoom () {
        ...
        const chatroomsRef = (0, _rtdb.rtdb).ref("/rooms/" + cs.rtdbId);
    ...
    setState (newState) {
        this.data = newState;
        for (let cb of this.listeners)cb();
    ...
    singIn (cb) {
        const cs = this.getState();
        if (cs.email && cs.from) fetch(BASE_URL + "auth", {
            method: "post",
            body: JSON.stringify({
    ...
    getData () {
        const cs = this.getState();
        fetch(BASE_URL + "rooms/" + cs.roomId + "?" + new URLSearchParams({
            userId: cs.userId
        })).then((data)=>{
            return data.json();
        }).then((data)=>{
...
var _database = require("firebase/compat/database");
const app = (0, _appDefault.default).initializeApp({
...
const rtdb = (0, _appDefault.default).database();

},{"firebase/compat/app":"2iVaZ","firebase/compat/database":"dTPXy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2iVaZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 */ class FirebaseAppImpl {
     ...
     * @internal
     */ _getService(name, instanceIdentifier = (0, _app._DEFAULT_ENTRY_NAME)) {
        var _a;
        this._delegate.checkDestroyed();
     ...
     * @internal
     */ _removeServiceInstance(name, instanceIdentifier = (0, _app._DEFAULT_ENTRY_NAME)) {
 ...
 */ function createFirebaseNamespaceCore(firebaseAppImpl) {
     ...
     */ function app(name) {
        name = name || _app._DEFAULT_ENTRY_NAME;
        if (!(0, _util.contains)(apps, name)) throw ERROR_FACTORY.create("no-app" /* NO_APP */ , {
            appName: name
        });
        return apps[name];
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dTPXy":[function(require,module,exports) {
var _databaseCompat = require("@firebase/database-compat");

},{"@firebase/database-compat":"lAtKT"}],"lAtKT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const logClient = new (0, _logger.Logger)("@firebase/database-compat");
 ...
 */ const validateBoolean = function(fnName, argumentName, bool, optional) {
    ...
    if (typeof bool !== "boolean") throw new Error((0, _util.errorPrefix)(fnName, argumentName) + "must be a boolean.");
};
 ...
 */ class OnDisconnect {
    ...
    cancel(onComplete) {
        ...
        if (onComplete) result.then(()=>onComplete(null), (error)=>onComplete(error));
        return result;
    }
    remove(onComplete) {
    ...
    update(objectToMerge, onComplete) {
        ...
        if (Array.isArray(objectToMerge)) {
            ...
            for(let i = 0; i < objectToMerge.length; ++i)newObjectToMerge["" + i] = objectToMerge[i];
 ...
 */ class DataSnapshot {
     ...
     */ child(path) {
        ...
        path = String(path);
        (0, _database._validatePathString)("DataSnapshot.child", "path", path, false);
     ...
     */ hasChild(path) {
        ...
        (0, _database._validatePathString)("DataSnapshot.hasChild", "path", path, false);
 ...
 */ class Query {
    ...
    on(eventType, callback, cancelCallbackOrContext, context) {
        ...
        switch(eventType){
            case "value":
                (0, _database.onValue)(this._delegate, valueCallback, cancelCallback);
                return callback;
            case "child_added":
                (0, _database.onChildAdded)(this._delegate, valueCallback, cancelCallback);
                return callback;
            case "child_removed":
                (0, _database.onChildRemoved)(this._delegate, valueCallback, cancelCallback);
                return callback;
            case "child_changed":
                (0, _database.onChildChanged)(this._delegate, valueCallback, cancelCallback);
                return callback;
            case "child_moved":
                (0, _database.onChildMoved)(this._delegate, valueCallback, cancelCallback);
                return callback;
            default:
    ...
    off(eventType, callback, context) {
        ...
        if (callback) {
            ...
            (0, _database.off)(this._delegate, eventType, valueCallback);
        } else (0, _database.off)(this._delegate, eventType);
    }
    /**
     * Get the server-value for this query, or return a cached value if not connected.
     */ get() {
        return (0, _database.get)(this._delegate).then((expSnapshot)=>{
     ...
     */ once(eventType, callback, failureCallbackOrContext, context) {
        ...
        const cancelCallback = (error)=>{
            if (ret.cancel) ret.cancel.call(ret.context, error);
     ...
     */ limitToFirst(limit) {
        ...
        return new Query(this.database, (0, _database.query)(this._delegate, (0, _database.limitToFirst)(limit)));
    }
    /**
     * Set a limit and anchor it to the end of the window.
     */ limitToLast(limit) {
        (0, _util.validateArgCount)("Query.limitToLast", 1, 1, arguments.length);
        return new Query(this.database, (0, _database.query)(this._delegate, (0, _database.limitToLast)(limit)));
    }
    /**
     * Given a child path, return a new query ordered by the specified grandchild path.
     */ orderByChild(path) {
        (0, _util.validateArgCount)("Query.orderByChild", 1, 1, arguments.length);
        return new Query(this.database, (0, _database.query)(this._delegate, (0, _database.orderByChild)(path)));
    }
    /**
     * Return a new query ordered by the KeyIndex
     */ orderByKey() {
        (0, _util.validateArgCount)("Query.orderByKey", 0, 0, arguments.length);
        return new Query(this.database, (0, _database.query)(this._delegate, (0, _database.orderByKey)()));
    }
    /**
     * Return a new query ordered by the PriorityIndex
     */ orderByPriority() {
        (0, _util.validateArgCount)("Query.orderByPriority", 0, 0, arguments.length);
        return new Query(this.database, (0, _database.query)(this._delegate, (0, _database.orderByPriority)()));
    }
    /**
     * Return a new query ordered by the ValueIndex
     */ orderByValue() {
        (0, _util.validateArgCount)("Query.orderByValue", 0, 0, arguments.length);
        return new Query(this.database, (0, _database.query)(this._delegate, (0, _database.orderByValue)()));
    }
    startAt(value = null, name) {
        (0, _util.validateArgCount)("Query.startAt", 0, 2, arguments.length);
        return new Query(this.database, (0, _database.query)(this._delegate, (0, _database.startAt)(value, name)));
    }
    startAfter(value = null, name) {
        (0, _util.validateArgCount)("Query.startAfter", 0, 2, arguments.length);
        return new Query(this.database, (0, _database.query)(this._delegate, (0, _database.startAfter)(value, name)));
    }
    endAt(value = null, name) {
        (0, _util.validateArgCount)("Query.endAt", 0, 2, arguments.length);
        return new Query(this.database, (0, _database.query)(this._delegate, (0, _database.endAt)(value, name)));
    }
    endBefore(value = null, name) {
        (0, _util.validateArgCount)("Query.endBefore", 0, 2, arguments.length);
        return new Query(this.database, (0, _database.query)(this._delegate, (0, _database.endBefore)(value, name)));
    }
    /**
     ...
     */ equalTo(value, name) {
        ...
        return new Query(this.database, (0, _database.query)(this._delegate, (0, _database.equalTo)(value, name)));
    }
    /**
     ...
     */ static getCancelAndContextArgs_(fnName, cancelOrContext, context) {
        ...
        if (cancelOrContext && context) {
            ...
            else throw new Error((0, _util.errorPrefix)(fnName, "cancelOrContext") + " must either be a cancel callback or a context object.");
        }
        return ret;
    }
    get ref() {
        return new Reference(this.database, new (0, _database._ReferenceImpl)(this._delegate._repo, this._delegate._path));
    }
}
class Reference extends Query {
     ...
     */ constructor(database, _delegate){
        super(database, new (0, _database._QueryImpl)(_delegate._repo, _delegate._path, new (0, _database._QueryParams)(), false));
        this.database = database;
        this._delegate = _delegate;
    }
    ...
    child(pathString) {
        ...
        return new Reference(this.database, (0, _database.child)(this._delegate, pathString));
    }
    ...
    set(newVal, onComplete) {
        ...
        const result = (0, _database.set)(this._delegate, newVal);
        if (onComplete) result.then(()=>onComplete(null), (error)=>onComplete(error));
        return result;
    }
    update(values, onComplete) {
        ...
        if (Array.isArray(values)) {
            const newObjectToMerge = {};
            for(let i = 0; i < values.length; ++i)newObjectToMerge["" + i] = values[i];
            values = newObjectToMerge;
            warn("Passing an Array to Firebase.update() is deprecated. Use set() if you want to overwrite the existing data, or an Object with integer keys if you really do want to only update some of the children.");
        }
        (0, _database._validateWritablePath)("Reference.update", this._delegate._path);
        (0, _util.validateCallback)("Reference.update", "onComplete", onComplete, true);
        const result = (0, _database.update)(this._delegate, values);
        if (onComplete) result.then(()=>onComplete(null), (error)=>onComplete(error));
        return result;
    }
    setWithPriority(newVal, newPriority, onComplete) {
        ...
        const result = (0, _database.setWithPriority)(this._delegate, newVal, newPriority);
        if (onComplete) result.then(()=>onComplete(null), (error)=>onComplete(error));
        return result;
    }
    remove(onComplete) {
        ...
        const result = (0, _database.remove)(this._delegate);
        if (onComplete) result.then(()=>onComplete(null), (error)=>onComplete(error));
        return result;
    }
    transaction(transactionUpdate, onComplete, applyLocally) {
        ...
        const result = (0, _database.runTransaction)(this._delegate, transactionUpdate, {
            applyLocally
        ...
        if (onComplete) result.then((transactionResult)=>onComplete(null, transactionResult.committed, transactionResult.snapshot), (error)=>onComplete(error, false, null));
        return result;
    }
    setPriority(priority, onComplete) {
        ...
        const result = (0, _database.setPriority)(this._delegate, priority);
        if (onComplete) result.then(()=>onComplete(null), (error)=>onComplete(error));
        return result;
    }
    push(value, onComplete) {
        ...
        const expPromise = (0, _database.push)(this._delegate, value);
        const promise = expPromise.then((expRef)=>new Reference(this.database, expRef));
        if (onComplete) promise.then(()=>onComplete(null), (error)=>onComplete(error));
    ...
    onDisconnect() {
        (0, _database._validateWritablePath)("Reference.onDisconnect", this._delegate._path);
        return new OnDisconnect(new (0, _database.OnDisconnect)(this._delegate._repo, this._delegate._path));
    }
    get key() {
        return this.getKey();
    }
 ...
 */ class Database {
     ...
     */ constructor(_delegate, app){
        ...
        this.INTERNAL = {
            ...
            forceWebSockets: (0, _database.forceWebSockets),
            forceLongPolling: (0, _database.forceLongPolling)
        };
    }
    /**
     ...
     */ useEmulator(host, port, options = {}) {
        (0, _database.connectDatabaseEmulator)(this._delegate, host, port, options);
    }
    ref(path) {
        (0, _util.validateArgCount)("database.ref", 0, 1, arguments.length);
        if (path instanceof Reference) {
            const childRef = (0, _database.refFromURL)(this._delegate, path.toString());
            return new Reference(this, childRef);
        } else {
            const childRef1 = (0, _database.ref)(this._delegate, path);
            return new Reference(this, childRef1);
        }
    }
    /**
     ...
     */ refFromURL(url) {
        ...
        const childRef = (0, _database.refFromURL)(this._delegate, url);
        return new Reference(this, childRef);
    }
    // Make individual repo go offline.
    goOffline() {
        (0, _util.validateArgCount)("database.goOffline", 0, 0, arguments.length);
        return (0, _database.goOffline)(this._delegate);
    }
    goOnline() {
        (0, _util.validateArgCount)("database.goOnline", 0, 0, arguments.length);
        return (0, _database.goOnline)(this._delegate);
    }
}
Database.ServerValue = {
    TIMESTAMP: (0, _database.serverTimestamp)(),
    increment: (delta)=>(0, _database.increment)(delta)
};
/**
 * @license
 * Copyright 2017 Google LLC
 ...
 */ function initStandalone({ app , url , version , customAuthImpl , namespace , nodeAdmin =false  }) {
    (0, _database._setSDKVersion)(version);
    /**
     * ComponentContainer('database-standalone') is just a placeholder that doesn't perform
     * any actual function.
     */ const authProvider = new (0, _component.Provider)("auth-internal", new (0, _component.ComponentContainer)("database-standalone"));
    authProvider.setComponent(new (0, _component.Component)("auth-internal", ()=>customAuthImpl, "PRIVATE" /* ComponentType.PRIVATE */ ));
    return {
        instance: new Database((0, _database._repoManagerDatabaseFromApp)(app, authProvider, /* appCheckProvider= */ undefined, url, nodeAdmin), app),
        namespace
    };
}
...
function registerDatabase(instance) {
    ...
    instance.INTERNAL.registerComponent(new (0, _component.Component)("database-compat", (container, { instanceIdentifier: url  })=>{
    ...
    }, "PUBLIC" /* ComponentType.PUBLIC */ ).setServiceProps(// firebase.database namespace properties
    {
        ...
        Database,
        DataSnapshot,
        enableLogging: (0, _database.enableLogging),
        INTERNAL,
        ServerValue
    }).setMultipleInstances(true));
    instance.registerVersion(name, version);
}
registerDatabase((0, _appCompatDefault.default));

},{"@firebase/app-compat":"ibzr5","@firebase/component":"bi1VB","@firebase/database":"cQryS","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cQryS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"process":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"klKMg":[function(require,module,exports) {
var _header = require("../../components/header/header");
var _formBtn = require("../../components/form-button/form-btn");
var _btn = require("../../components/button/btn");
var _state = require("../../state");
class Chat extends HTMLElement {
    ...
    constructor(){
        ...
        (0, _state.state).subscribe(()=>{
            let current = (0, _state.state).getState();
    ...
    render() {
        this.roomId = (0, _state.state).getState().roomId;
        let style = document.createElement("style");
        style.innerHTML = `
            .chatContainer{
                width:${90}%;
        ...
        btn.addEventListener("click", (e)=>{
            ...
            (0, _state.state).pushMessages(message);
            console.log(message);
        });
        this.shadow.appendChild(style);
    }
...
},{"../../components/header/header":"adC58","../../components/form-button/form-btn":"6SSK9","../../components/button/btn":"8Djxy","../../state":"gYADE"}],"6SSK9":[function(require,module,exports) {
var _btn = require("../button/btn");
...
},{"../button/btn":"8Djxy"}]},["YYQ28","cxZJI"], "cxZJI", "parcelRequire1ea1")

//# sourceMappingURL=index.9f072a38.js.map
